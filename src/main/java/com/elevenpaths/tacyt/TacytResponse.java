...
/**
 * This class models a response from any of the endpoints in the Path5 API.
...
public class TacytResponse {
     ...
     */
    public TacytResponse(String json) {
        this(new JsonParser().parse(json));
    }

    /**
     * @param json a JsonElement created from the response of one of the methods of the Path5 API
     * @throws NullPointerException when the json element is null, preventing the instantiation of the object
     */
    public TacytResponse(JsonElement json) {
